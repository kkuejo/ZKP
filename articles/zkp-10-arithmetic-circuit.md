...
Poseidon ハッシュの1ラウンド（詳細は Article 27）:
...
**方法2: Lookup Argument (Article 19)**
...
**Poseidon は SHA の 100 倍以上効率的**。詳細は Article 27。
...
### 7.4 カスタムゲート（Plonkish, Article 19）
...
**展開できない**（ループ深さが動的）。**再帰 SNARK (Article 20)** で対応する。
